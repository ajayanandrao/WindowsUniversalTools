...
const CollactionCard = () => {
    const bg_img = {
        backgroundImage: `url(${"https://store-images.s-microsoft.com/image/apps.43402.9007199266242715.ce32f66d-189c-4407-be9c-b0c09aff330d.a4fca33d-1c6d-414b-8f1f-335f7a53ff0c?w=1922&h=1080&q=60"})`
    }
    const card_bg_img = {
        backgroundImage: `url(${"https://store-images.s-microsoft.com/image/apps.57377.9007199266242715.ce32f66d-189c-4407-be9c-b0c09aff330d.cc01ba3d-6c9b-4d3d-bf03-e5422f1c6666?mode=scale&q=90&h=300&w=200"})`
    }
                    ...
                    <div className='bg-linear-container'>
                        ...
                        <div className='flex-container'>
                            ...
                            <div className='text-container'>
                                <h1 className='game-title'>Asphalt 8: Airborne</h1>
                                <span className="game-comp"> 2018 . Gameloft SE </span>
