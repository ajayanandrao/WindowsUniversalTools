...
import HaloScreen from './HaloScreen';
import Footer from '../../Footer';
import { Link } from 'react-router-dom';

const Halo = () => {
    const bg_img = {
        backgroundImage: `url(${"https://images.cgames.de/images/gsgp/290/halo-spartan-assault_2414485.jpg"})`
    }
    const card_bg_img = {
        backgroundImage: `url(${"https://upload.wikimedia.org/wikipedia/en/6/6d/Halo-spartan-assault-boxart.png"})`
    }
    return (
        <>
                    ...
                    <div className='bg-linear-container'>
                        ...
                        <div className='flex-container'>
                            ...
                            <div className='text-container'>
                                <h1 className='game-title'>Halo: Spartan Assault</h1>
                        ...
                        <div className='additional-container'>
                            ...
                            <div className='add-flex mt-5'>
                                <div className='col-4'>
                                    ...
                                    <div style={{ fontSize: "14px", color: "#a6a5a7", fontWeight: "500" }}>1.5 GB</div>
                                </div>
