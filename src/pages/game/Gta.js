...
import GtaScreen from './GtaScreen';
...
const Gta = () => {
    const bg_img = {
        backgroundImage: `url(${"https://i.ytimg.com/vi/TtWxflUBlI0/maxresdefault.jpg"})`
    }
    const card_bg_img = {
        backgroundImage: `url(${"https://store-images.s-microsoft.com/image/apps.8135.66515090704019777.7fa547c1-c211-4229-a4d3-3ceef762e0a4.0bb0ac0a-9d63-4d91-8e53-f2e39a040bcd?q=90&w=270&h=405&mode=crop&format=jpg&background=%23FFFFFF"})`
    }
                    ...
                    <div className='bg-linear-container'>
                        ...
                        <div className='flex-container'>
                            ...
                            <div className='text-container'>
                                <h1 className='game-title'>GTA</h1>
                        ...
                        <div className='additional-container'>
                            ...
                            <div className='add-flex mt-5'>
                                <div className='col-4'>
                                    ...
                                    <div style={{ fontSize: "14px", color: "#a6a5a7", fontWeight: "500" }}>1.3 GB</div>
                                </div>
