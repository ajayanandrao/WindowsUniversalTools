...
const Todo = () => {
    ...
    const bg_img = {
        backgroundImage: `url(${"https://mspoweruser.com/wp-content/uploads/2018/09/Microsoft-To-Do.jpg"})`
    }
    const card_bg_img = {
        backgroundImage: `url(${"https://mir-s3-cdn-cf.behance.net/project_modules/disp/d1615f116697567.60aa4da8474d7.png"})`
    }
