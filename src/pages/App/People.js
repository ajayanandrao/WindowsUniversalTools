...
import PeopleApp from "./../../Apps/PeopleApp.zip";

const People = () => {

    const bg_img = {
        backgroundImage: `url(${"https://www.onmsft.com/wp-content/uploads/2015/09/win10-windows-contacts.jpg"})`
    }
    const card_bg_img = {
        backgroundImage: `url(${"http://store-images.s-microsoft.com/image/apps.198.13510798882270039.d8e24d48-9675-4047-92c3-ca9eeb004c25.4f708644-24b0-4785-bf35-8f526c687818"})`
    }
                    ...
                    <div className='bg-linear-container'>
                        ...
                        <div className='flex-container'>
                            ...
                            <div className='text-container'>
                                <h1 className='game-title'>People</h1>
                                ...
                                <a href={PeopleApp} download="PeopleApp.zip">
