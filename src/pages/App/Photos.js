...
const Photos = () => {
    ...
    const bg_img = {
        backgroundImage: `url(${"https://4kwallpapers.com/images/wallpapers/windows-11-dark-background-bloom-5k-1440x900-8399.png"})`
    }
    const card_bg_img = {
        backgroundImage: `url(${"http://store-images.s-microsoft.com/image/apps.54930.9007199266252409.55c8a156-d5a0-4204-88cb-cad97cec8cf5.3041e7a4-ed61-4495-a21c-4389ab6042a0"})`
    }
    return (
        <>
